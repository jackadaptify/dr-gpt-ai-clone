...
export default function UsersList() {
    ...
    if (loading) return <div className="text-zinc-500">Carregando usuários...</div>;

    return (
        <div className="space-y-6">
            <div>
                <h2 className="text-3xl font-bold mb-2">Usuários</h2>
                <p className="text-zinc-400">Gerencie os usuários registrados no sistema.</p>
            </div>
                ...
                <table className="w-full text-left border-collapse">
                    <thead>
                        <tr className="border-b border-white/5 bg-white/5">
                            <th className="p-4 text-xs font-bold text-zinc-400 uppercase tracking-wider">Usuário</th>
                            <th className="p-4 text-xs font-bold text-zinc-400 uppercase tracking-wider">Email</th>
                            <th className="p-4 text-xs font-bold text-zinc-400 uppercase tracking-wider">Role</th>
                            <th className="p-4 text-xs font-bold text-zinc-400 uppercase tracking-wider text-right">Ações</th>
                        </tr>
                    </thead>
                    <tbody>
                        {users.map(user => (
