    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            if (isLogin) {
                ...
                if (error) throw error;
                // Auto login or show message? Supabase usually requires email confirmation by default, 
                // but for dev we might want to handle it. 
                // If email confirmation is off, they are signed in.
                // If on, we should show a message.
                // For this clone, we assume it might work or show "Check email".
            }
        } catch (err: any) {
